...
public class UsuarioController {
    ...
    public ModelAndView cadastrar() {
        ...
        modelAndView.addObject("tiposDeUsuarios", Perfil.values());
    ...
    public String cadastrar(@Valid Usuario usuario, BindingResult bindingResult, ModelMap model,
        ...
        UsuarioValidator usuarioValidator = new UsuarioValidator(this.usuarioService);
        usuarioValidator.validate(usuario, bindingResult);
        if (bindingResult.hasErrors()) {
           
            model.addAttribute("tiposDeUsuarios", Perfil.values());
        ...
        if (usuario.getId() == null) {
            ...
            usuarioService.atualizar(usuario,usuario.getId());
